...
void ModelPopulate (){
	...
	for (j = 0; j <J; j++) {
		for (k = 0; k < K; k++) {
			//sprintf(colname[counter], "z%3d_%3d", j, k);
			lb[counter] = 0;
			ub[counter] = 1;
			obj[counter] =0;
			coltype[counter++] = 'C';
